...
%
\textit{(a)}
Running our algorithm with a different seed each time, we see that it can converge to different results, some of them quite bad (seed=44 give a distorsion of 1500, whereas usually distorsion is around 1100).
\begin{figure}[H]
\centering
\noindent\includegraphics[scale=0.5]{kmeans_pourri.png}
\caption{Clusters and centroids obtained by K-Means for seed = 44}
\end{figure}

\begin{figure}[H]
\centering
\noindent\includegraphics[scale=0.5]{kmeans_good.png}
\caption{Clusters and centroids obtained by K-Means for seed = 45}
\end{figure}
%
%TODO: compare centroids and distorsions
%
\textit{(b)}
\begin{figure}[H]
\centering
